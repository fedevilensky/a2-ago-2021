...
class HashTable {
    ...
    static abstract class Hasher<T> {
        abstract public int hash(T key);
    }

    static class ClosedHashTable<K, V> {
    ...
    static class OpenHashTable<K, V> {

        private Object[] table;
        private Hasher<K> hasher;

        OpenHashTable(Hasher<K> hasher, int size){
            this.hasher = hasher;
            this.table = new Object[size];
        }
        ...
        public void set(K key, V value) {
            ...
            int pos = 0;
            // ...
            var list = (LinkedList<Pair<K,V>>) table[pos];
            // ...
            // TODO
        }
